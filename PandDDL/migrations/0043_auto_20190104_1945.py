# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2019-01-04 19:45
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('PandDDL', '0042_auto_20190104_1938'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='runnerup',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='runnerup', to='PandDDL.Player'),
        ),
        migrations.AlterField(
            model_name='competition',
            name='winner',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='winner', to='PandDDL.Player'),
        ),
        migrations.AlterField(
