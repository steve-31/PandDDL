...
urlpatterns = [
    ...
    url(r'^fixtures/print/(?P<lge_gender>[A-Za-z0-9\']+)s_(?P<lge_season>[A-Za-z0-9]+)_(?P<lge_year>[0-9]+)/div(?P<div_id>[A-Za-z0-9]+)/$', views.printFixtures, name='printFixtures'),
    url(r'^fixtures/print/(?P<team_name>[A-Za-z0-9\-\ ]+)/$', views.printTeamFixtures, name='printTeamFixtures'),
